...
public class GeoServerServiceImpl implements GeoServerService {
	...
	static String NewStyle = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<sld:StyledLayerDescriptor xmlns=\"http://www.opengis.net/sld\" xmlns:sld=\"http://www.opengis.net/sld\" xmlns:ogc=\"http://www.opengis.net/ogc\" xmlns:gml=\"http://www.opengis.net/gml\" version=\"1.0.0\">"
			+ "<sld:NamedLayer><sld:Name>Default Styler</sld:Name>" 
			+ "<sld:UserStyle>"
			+ "<sld:Name>Default Styler</sld:Name>"
			+ "<sld:Title>SLD New Development</sld:Title>"
			+ "<sld:FeatureTypeStyle>"
			+ "<sld:Name>name</sld:Name>"
			+ "<sld:Rule>"
			+ "<sld:Name>LessThan20</sld:Name>"
			+ "<sld:Title>Less Than 20</sld:Title>"
			+ "<ogc:Filter>"			
			...
			+ "<sld:Rule>"
			+ "<sld:Name>Between20And40</sld:Name>"
			+ "<sld:Title>Between 20 And 40</sld:Title>"			
			+ "<ogc:Filter>"
			+ "<ogc:And>"
			...
			+ "<sld:Rule>"
			+ "<sld:Name>Between40And60</sld:Name>"
			+ "<sld:Title>Between 40 And 60</sld:Title>"			
			+ "<ogc:Filter>"
			+ "<ogc:And>"
			+ "<ogc:PropertyIsGreaterThanOrEqualTo>"
	        + "<ogc:PropertyName>Priority</ogc:PropertyName>"
			...
			+ "<sld:PolygonSymbolizer>"
			+ "<sld:Fill>"
			+ "<sld:CssParameter name=\"fill\">#CC99CC</sld:CssParameter>"
			+ "<CssParameter name=\"fill-opacity\">0.5</CssParameter>"
			+ "</sld:Fill>"
			+ "<Stroke>"
			+ "<CssParameter name=\"stroke\">#FFFFFF</CssParameter>"
			...
			+ "<sld:Rule>"
			+ "<sld:Name>Between60And80</sld:Name>"
			+ "<sld:Title>Between 60 And 80</sld:Title>"			
			+ "<ogc:Filter>"
			+ "<ogc:And>"
			+ "<ogc:PropertyIsGreaterThanOrEqualTo>"
	        + "<ogc:PropertyName>Priority</ogc:PropertyName>"
	...
	public boolean publishNewStyle(String styleName) throws HousingException, URISyntaxException {
		boolean published = true;
		if (reader.existsStyle(styleName)) {
			published = publisher.updateStyle(NewStyle, styleName);
		} else {
			published = publisher.publishStyle(NewStyle, styleName);
		}
		if (!published) {
			throw new HousingException(Messages._STYLE_PUBLISH_FAILED);
		}
